...
contract RebaseTokenTest is Test {
    ...
    function setUp() public {
        ...
        rebaseToken.grantRoleMintAndBurn(address(vault));
        vm.stopPrank();
    }
    ...
    function testTransfer(uint256 amount, uint256 amountToSend) public {
        ...
        vm.prank(owner);
        rebaseToken.changeInterestRate(4e10);
    ...
    function testSetInterestRate(uint256 newInterestRate) public {
        ...
        vm.startPrank(owner);
        rebaseToken.changeInterestRate(newInterestRate);
        uint256 interestRate = rebaseToken.getInterestRate();
    ...
    function testInterestRateCanOnlyDecrease(uint256 newInterestRate) public {
        ...
        vm.prank(owner);
        vm.expectPartialRevert(bytes4(RebaseToken.RebaseToken__NewInterestCanOnlyBeLower.selector));
        rebaseToken.changeInterestRate(newInterestRate);
